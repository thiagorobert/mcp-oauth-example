...
class TestFlaskMCPServer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        flask_mcp_server._github_access_token = self.test_token
    ...
    def test_setup_logging(self):
        """Test logging setup functionality."""
        # Test non-verbose mode
        flask_mcp_server.setup_logging(verbose=False)
    ...
    def test_flask_app_initialization(self):
        ...
        self.assertIsNotNone(flask_mcp_server.mcp)
...
class TestFlaskMCPServerAsync:
    ...
    async def test_make_github_request_success(self, mock_client):
        ...
        assert headers['User-Agent'] == flask_mcp_server.USER_AGENT
    ...
    async def test_list_repositories_no_token(self):
        ...
        # Clear the token
        original_token = flask_mcp_server._github_access_token
        flask_mcp_server._github_access_token = None
        ...
        try:
            ...
            # Restore the token
            flask_mcp_server._github_access_token = original_token
    ...
    async def test_get_repository_info(self, mock_request):
        ...
        result = await flask_mcp_server.get_repository_info("user", "testrepo")
    ...
    async def test_token_flow_integration(self):
        ...
        try:
            with patch.object(client_with_oauth, 'TOKEN_FILE', tmp_path):
                ...
                # Set token in server
                flask_mcp_server._github_access_token = loaded_token
                assert flask_mcp_server._github_access_token == test_token
